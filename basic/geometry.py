...
def rotation(file_dir,
    ...
    source_coord = np.dot(lin.inv(h_matrix), coord_homo).astype(np.int64)

    for i, j in zip(source_coord.transpose(1,0), coord_homo.transpose(1,0)):
        #i[0] : x, i[1] : y, || frame shape : (y, x, z)
...
file_dir = "D:/cv/data/prac/KakaoTalk_20220518_215457616.jpg"
